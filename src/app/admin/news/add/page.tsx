    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-[var(--text-primary)]">Dodaj Novost</h1>
                    <p className="text-[var(--text-secondary)]">Objavi nove informacije na web stranicu</p>
                </div>
                <Link href="/admin/news" className="text-[var(--text-secondary)] hover:text-[var(--primary)] font-medium flex items-center gap-2">
                ...
                <form action={addNews} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="npr. Zlatna medalja na prvenstvu"
                            />
                        </div>
                        <div>
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            <label className="block text-sm font-medium text-[var(--text-secondary)]">Slika</label>
                            <button
                                type="button"
                            ...
                            <div className="relative border-2 border-dashed border-[var(--border)] rounded-xl p-6 text-center hover:border-[var(--primary)] transition-colors cursor-pointer bg-[var(--background-alt)]">
                                ...
                                <div className="pointer-events-none">
                                    ...
                                    <p className="text-sm text-[var(--text-secondary)]">
                                        {fileName ? `Odabrano: ${fileName}` : 'Kliknite za upload slike'}
                                    </p>
                                </div>
                            </div>
                        )}
                    ...
                    <div className="flex items-center gap-3 p-4 bg-[var(--background-alt)] rounded-xl border border-[var(--border)]">
                        <input
                            type="checkbox"
                            name="featured"
                            id="featured"
                        ...
                        />
                        <label htmlFor="featured" className="text-sm font-medium text-[var(--text-primary)] cursor-pointer select-none">
                            Izdvoji na početnu stranicu (Featured)
                        </label>
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-[var(--text-secondary)] mb-2">Sadržaj</label>
                        <textarea
                            name="content"
                            required
                            rows={8}
