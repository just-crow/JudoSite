    ...
    return (
        <div className="max-w-2xl mx-auto animate-fade-in-up">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-[var(--text-primary)]">Dodaj Sponzora</h1>
                    <p className="text-[var(--text-secondary)]">Unesite podatke o novom sponzoru</p>
                </div>
            </div>
            ...
            <form action={createSponsor} className="space-y-6">
                <div className="card p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input name="website" type="url" className="w-full px-4 py-2 border border-[var(--border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-[var(--text-primary)]" placeholder="https://..." />
                    </div>
