import { getCompetitions, deleteCompetition, syncCompetitionsFromJudoManagerAction } from "@/actions/competitions"
        ...
        <div className="space-y-8 animate-fade-in-up">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <form action={syncCompetitionsFromJudoManagerAction}>
                        <button type="submit" className="px-4 py-2 rounded-lg border border-[var(--border)] text-[var(--text-primary)] hover:bg-[var(--background-alt)] transition-colors">
                            Sync JudoManager
                        </button>
                    </form>
