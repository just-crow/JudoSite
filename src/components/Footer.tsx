...
export default function Footer() {
    return (
        <footer className="bg-[var(--primary-dark)] border-t border-[var(--border)]">
            {/* Main footer */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <Link href="/" className="flex items-center gap-3 mb-6">
                            <div className="w-14 h-14 bg-[var(--secondary)] rounded-full flex items-center justify-center">
                                <span className="text-3xl font-bold text-[var(--primary-dark)]">柔</span>
                            </div>
                            <div>
                                <h2 className="text-2xl font-bold text-white">Judo Klub</h2>
                                <p className="text-sm text-[var(--text-secondary)]">Sarajevo</p>
                            </div>
                        </Link>
                        ...
                        <div className="flex gap-4">
                            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[var(--surface)] flex items-center justify-center text-[var(--text-secondary)] hover:bg-[var(--secondary)] hover:text-[var(--primary-dark)] transition-all">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.77,7.46H14.5v-1.9c0-.9.6-1.1,1-1.1h3V.5h-4.33C10.24.5,9.5,3.44,9.5,5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4Z" /></svg>
                            </a>
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[var(--surface)] flex items-center justify-center text-[var(--text-secondary)] hover:bg-[var(--secondary)] hover:text-[var(--primary-dark)] transition-all">
                            ...
                            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[var(--surface)] flex items-center justify-center text-[var(--text-secondary)] hover:bg-[var(--secondary)] hover:text-[var(--primary-dark)] transition-all">
                    ...
                    {/* Links */}
                    <div>
                        <h3 className="text-white font-semibold mb-4">Novosti</h3>
                        <ul className="space-y-3">
                            {footerLinks.novosti.map((link) => (
                                <li key={link.href}>
                                    <Link href={link.href} className="text-[var(--text-secondary)] hover:text-[var(--secondary)] transition-colors">
                                        {link.label}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-4">Klub</h3>
                        <ul className="space-y-3">
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-4">Podrška</h3>
                        <ul className="space-y-3">
            ...
            <div className="border-t border-[var(--border)]">
                <div className="container py-6 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex gap-6 text-sm">
                        <Link href="/privatnost" className="text-[var(--text-muted)] hover:text-[var(--secondary)]">
                            Politika privatnosti
                        </Link>
                        <Link href="/uslovi" className="text-[var(--text-muted)] hover:text-[var(--secondary)]">
                            Uslovi korištenja
                        </Link>
                    </div>
                </div>
